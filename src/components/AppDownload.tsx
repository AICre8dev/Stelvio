          ...
          <div className="app-left text-white">
            ...
            <div className="flex items-center gap-3 mb-8">
              <div className="w-12 h-12 bg-white rounded-2xl flex items-center justify-center shadow-lg">
                <span className="text-[#6C63FF] font-bold text-xl">S</span>
              </div>
              <span className="text-white font-bold text-2xl tracking-tight">Stelvio</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 mt-10">
              ...
              <a
                ...
                className="flex items-center gap-3 bg-black/30 hover:bg-black/50 backdrop-blur-sm border border-white/20 rounded-2xl px-6 py-4 transition-all duration-300 hover:scale-105"
              >
                <svg className="w-8 h-8 flex-shrink-0" viewBox="0 0 512 512" fill="none" xmlns="http://www.w3.org/2000/svg">
                  {/* Google Play triangle icon — 4 colored segments */}
                  <path d="M42.27 6.06C35.08 9.6 30 17.2 30 27.2v457.6c0 10 5.08 17.6 12.27 21.14L278.4 256 42.27 6.06z" fill="#4DB6AC"/>
                  <path d="M350.47 178.02L278.4 256l72.07 77.98 86.93-49.98c14.4-8.27 14.4-21.73 0-30L350.47 178.02z" fill="#FFD740"/>
                  <path d="M278.4 256L42.27 506.94c2.13 1.07 4.53 1.73 7.07 1.73 3.47 0 7.2-1.07 11.07-3.34l290.06-171.35L278.4 256z" fill="#F44336"/>
                  <path d="M278.4 256L350.47 178.02 60.41 6.67C56.54 4.4 52.81 3.33 49.34 3.33c-2.54 0-4.94.67-7.07 1.73L278.4 256z" fill="#2196F3"/>
                </svg>
                <div>
